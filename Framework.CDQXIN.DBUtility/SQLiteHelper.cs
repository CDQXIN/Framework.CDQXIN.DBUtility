...
namespace Framework.CDQXIN.DBUtility
{
    public class SQLiteHelper
    {
        //数据库连接字符串(web.config来配置)，可以动态更改SQLString支持多数据库.        
        public static string DataBasePath =""; // AppDomain.CurrentDomain.BaseDirectory+"data.db";//@"\Database\Mobile.s3db";
        public static string connectionString = "Data Source=" + DataBasePath + ";Version=3;Pooling=False;Max Pool Size=100;";
